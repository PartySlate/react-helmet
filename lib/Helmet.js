...
var commitTagChanges = function commitTagChanges(newState, cb) {
    ...
    var tagUpdates = {
        baseTag: updateTags(TAG_NAMES.BASE, baseTag, { placement: placement }),
        linkTags: updateTags(TAG_NAMES.LINK, linkTags, { placement: placement }),
        metaTags: updateTags(TAG_NAMES.META, metaTags, { placement: placement }),
        noscriptTags: updateTags(TAG_NAMES.NOSCRIPT, noscriptTags, { placement: placement }),
        scriptTags: updateTags(TAG_NAMES.SCRIPT, scriptTags, { placement: placement }),
        styleTags: updateTags(TAG_NAMES.STYLE, styleTags, { placement: placement })
    };
...
var updateTags = function updateTags(type, tags, _ref) {
    ...
    newTags.forEach(function (tag) {
        return headElement.insertAdjacentElement(placement === 'top' ? 'afterbegin' : 'beforeend', tag);
    });
...
var mapStateOnServer = function mapStateOnServer(_ref2) {
    var baseTag = _ref2.baseTag,
        bodyAttributes = _ref2.bodyAttributes,
        encode = _ref2.encode,
